...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('booking', '0002_auto_20180603_0914'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('IN', 'Informed'), ('CA', 'Canceled'), ('PA', 'Paid'), ('PE', 'Pending'), ('SW', 'Switched'), ('WL', 'Waiting List')], max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('IN', 'Informed'), ('CA', 'Canceled'), ('PA', 'Paid'), ('PE', 'Pending'), ('SW', 'Switched'), ('WL', 'Waiting List')], default='PE', max_length=15, null=True)),
                ('date', models.DateField(auto_now_add=True)),
                ('datetime', models.DateTimeField(auto_now_add=True)),
